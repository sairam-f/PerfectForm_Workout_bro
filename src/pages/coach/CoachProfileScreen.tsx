...
import { Settings, ChevronRight, Bell, User, Users, Shield, LogOut, HelpCircle, BarChart3 } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Users, label: "Manage Clients", description: "Add or remove clients" },
        ...
        <div className="bg-card rounded-2xl border border-border p-5">
          <div className="flex items-center gap-4">
            <Avatar className="w-20 h-20 ring-4 ring-primary/20">
              ...
              <AvatarFallback className="text-2xl bg-primary/10 text-primary">MK</AvatarFallback>
            </Avatar>
            <div>
              <h2 className="text-xl font-bold text-foreground">Coach Mike</h2>
              <p className="text-muted-foreground text-sm">Certified Personal Trainer</p>
